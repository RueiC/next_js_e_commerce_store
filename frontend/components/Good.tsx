...
const Good = ({ product }: { product: Product }) => {
  ...
  return (
    <m.div
      className='relative flex justify-end bg-white shadow-lg w-full h-[27rem] rounded-[2.5rem] p-[3.5rem] mb-[5rem] hover:scale-105 hover:-rotate-1 transition-all duration-200 ease-in-out'
