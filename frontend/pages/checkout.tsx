...
import { CartItem, CheckoutForm, Spinner } from '../components';
...
const Checkout = () => {
  ...
  useEffect(() => {
    if (cartItems.length < 1) Router.push('/');
  }, []);
  ...
  return (
    <>
      {cartItems ? (
        <m.section
          className='flex flex-col md:flex-row justify-center items-center md:items-start gap-[10rem] px-[5rem] md:px-[16rem] py-[5rem]'
